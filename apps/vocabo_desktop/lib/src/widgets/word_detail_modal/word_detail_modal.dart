...
class WordDetailModal extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isThisPlaying = showDetail &&
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildContentSection(
                    vocabulary, hasTranslation, hasMeaning, examples,
                  ),
                  const SizedBox(height: VocaboSpacing.xl),
                  _buildDateSection(),
                  const SizedBox(height: VocaboSpacing.xl),
  ...
  Widget _buildContentSection(
    ...
    final hasLeftColumn = hasTranslation || hasMeaning;

    if (!hasLeftColumn && examples.isEmpty) {
      return const SizedBox.shrink();
    }

    if (examples.isEmpty) {
      return _buildTextColumns(vocabulary, hasTranslation, hasMeaning);
    }
      ...
      children: [
        if (hasLeftColumn) ...[
          Expanded(
            flex: 2,
            child:
                _buildTextColumns(vocabulary, hasTranslation, hasMeaning),
          ),
